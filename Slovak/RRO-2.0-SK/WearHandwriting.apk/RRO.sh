...
$aapt package -f -M AndroidManifest.xml -S res/ -I $up/tools/android.jar -F WearHandwriting-overlay.apk

echo "Signing overlay.apk";

java -Xmx4048m -jar $up/tools/apksigner.jar sign --key $key_pk8 --cert $key_pem WearHandwriting-overlay.apk			

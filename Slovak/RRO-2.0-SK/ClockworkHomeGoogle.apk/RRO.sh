...
path=$up/RRO-2.0-SK/ClockworkHomeGoogle.apk
...
$aapt package -f -M $path/AndroidManifest.xml -S $path/res/ -I $up/tools/android.jar -F $up/output/ClockworkHomeGoogle-overlay.apk

...
path=$up/RRO-2.0-SK/RemindersPrebuiltWearable.apk
...
$aapt package -f -M $path/AndroidManifest.xml -S $path/res/ -I $up/tools/android.jar -F $up/output/RemindersPrebuiltWearable-overlay.apk
